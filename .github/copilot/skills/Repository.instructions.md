...
- 主にRとPythonを使用してコードを生成します。
  ...
  - 可視化コードの場合、`.github/copilot/skills/Visualization_skills.instructions.md` に従ってください。
  - 日本語ドキュメントの場合、`.github/copilot/skills/Japanese_documentation_skills.instructions.md` に従ってください。
